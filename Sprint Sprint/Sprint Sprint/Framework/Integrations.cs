...
namespace Sprint_Sprint.Framework
{
    ...
    class Integrations
    {
        ...
        {
            api.RegisterSimpleOption(this.ModManifest, "Disable Sprint If Player Is Too Tired", "Enable feature where it disables sprinting if player stamina is below the Tired Stamina value",
